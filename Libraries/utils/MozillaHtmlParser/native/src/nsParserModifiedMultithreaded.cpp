...
// Added by ohad 15.2.2006 :
// Start
#include "prlock.h"
static PRLock*         mLock;
#define LOCK PR_Lock(mLock);
#define UNLOCK PR_Unlock(mLock);
